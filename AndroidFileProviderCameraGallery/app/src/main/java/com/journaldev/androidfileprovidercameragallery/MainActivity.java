        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
             ...
             /*   ImageProcessClass imageProcessClass = new ImageProcessClass();
                ...
                HashMapParams.put("image_data", filepath);

                String FinalData = imageProcessClass.ImageHttpRequest("https://jagadeeswararaop4.000webhostapp.com/uploadimage.php", HashMapParams);
                Log.d( "TAG", "doInBackground: "+FinalData );
...
*/
                ...
                HttpPost httppost = new HttpPost("https://jagadeeswararaop4.000webhostapp.com/uploadimage.php");
                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(0);
                nameValuePairs.add(new BasicNameValuePair("image_tag", GetImageNameFromEditText));
